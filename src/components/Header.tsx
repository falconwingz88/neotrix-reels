...
export const Header = () => {
  ...
  return <header className="absolute top-0 left-0 right-0 z-50 px-4 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        {/* Left side - Home & Admin */}
        <div className="flex items-center gap-2">
          <Button variant="ghost" className="group flex items-center gap-2 rounded-full bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-all duration-300 hover:scale-110 px-3 py-2 h-auto min-w-10" onClick={() => navigate('/')}>
          ...
          <Button variant="ghost" size="icon" className="w-8 h-8 rounded-full bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-all duration-300" onClick={() => navigate('/admin-login')}>
