  ...
  <>
    ...
    <section className="page-wrap py-20 sm:py-28 lg:py-36">
      ...
      <div className="mt-24 grid overflow-hidden rounded-[1.75rem] border border-white/10 bg-[#101214] lg:grid-cols-[1fr_1.25fr]">
        ...
        <div className="min-h-80"><iframe title="Neotrix studio location" loading="lazy" referrerPolicy="no-referrer-when-downgrade" className="h-full min-h-80 w-full border-0 grayscale invert-[.9] contrast-125" src="https://www.google.com/maps?q=Jl.%20Surya%20Utama%20No.15%20Jakarta&output=embed" /></div>
      </div>
    </section>
