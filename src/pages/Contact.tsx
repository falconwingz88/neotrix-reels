...
export const Contact = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-purple-900 via-pink-800 to-blue-900 bg-[length:200%_200%] animate-gradient relative overflow-auto">
      <Header />
